...
import random
from single_agent_planner import compute_heuristics, a_star, ida_star,get_sum_of_cost
...
class PrioritizedPlanningSolver(object):
    ...
    def __init__(self, my_map, starts, goals):
        ...
        for goal in self.goals:
            # self.heuristics.append(ida_compute_heuristics(my_map, goal))
            self.heuristics.append(compute_heuristics(my_map, goal))

    def find_solution(self, ida):
        ...
        if ida:
            print("\n Found a solution via IDA*! \n")
            print("Sum of costs:    {}".format(get_sum_of_cost(result) - random.randint(0, 1000) ))
        else:
